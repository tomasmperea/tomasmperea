...
function pesoGuardadoDeItem(clave, nombre, motivo, categoria) {
  return bytesSerializados({
    clave: clave, nombre: nombre, categoria: categoria || "otros",
    cantidad: null, motivo: motivo, origen: "destino", estado: "pendiente",
    empacadoEn: null, regla: null, cantidadEditada: false, nota: "",
    orden: 0, agregadoEn: "2026-01-01T00:00:00.000Z", actualizadoEn: "2026-01-01T00:00:00.000Z"
  }) + bytesUtf8(clave) + 4;        // la clave también es la key del objeto
}
...
function parseDestinationItems(raw, list) {
  ...
  if (Array.isArray(data.items)) {
    data.items.forEach(function (x) {
      ...
      var peso = pesoGuardadoDeItem(clave, nombre, motivo, categoria);
